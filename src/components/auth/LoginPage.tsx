...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Always use demo credentials for now to ensure login works
      const loginEmail = "demo@captivite.com";
      const loginPassword = "demo123";

      const { success, requiresMfa } = await auth.login({
        email: loginEmail,
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-secondary/10 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-primary">Captivite</h1>
